...
export default function SignInPage() {
  ...
  const handleEmailSubmit = (e) => {
    ...
    alert('Email login is offline. Use Google Authentication.');
  };
        ...
        <div style={{ flex: '1', padding: '40px' }}>
          ...
          <form onSubmit={handleEmailSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <input 
              ...
              style={{ padding: '10px', background: '#0a0a0a', border: '1px solid #333', borderRadius: '4px', color: '#fff', outline: 'none' }} 
            />
            <button type="submit" style={{ padding: '10px', background: '#222', color: '#888', border: '1px solid #333', borderRadius: '4px', fontWeight: '600' }}>
              Log In
            </button>
          </form>
        </div>
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '40px' }}>
          <button 
            ...
            style={{ 
              ...
              padding: '12px', background: '#fff', color: '#000', border: 'none', borderRadius: '4px', fontWeight: '600', cursor: 'pointer'
            }}
          >
            Sign in with Google
          </button>
